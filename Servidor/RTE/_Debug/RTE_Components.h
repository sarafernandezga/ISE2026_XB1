...
/* Keil.MDK-Pro::Network:Service:DNS Client:7.18.0 */
#define RTE_Network_DNS_Client          /* Network DNS Client */
/* Keil.MDK-Pro::Network:Service:SNTP Client:7.18.0 */
#define RTE_Network_SNTP_Client         /* Network SNTP Client */
/* Keil.MDK-Pro::Network:Service:Web Server Compact:HTTP:7.18.0 */
